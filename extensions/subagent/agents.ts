...
/**
 * Directory of agent definitions bundled with this package (pstack's own agents:
 * poteto-agent, comment-sicko, general-purpose). Resolved relative to this file
 * so it works regardless of where the package is installed.
 */
export const bundledAgentsDir = fileURLToPath(new URL("../../agents/", import.meta.url));
...
export function discoverAgents(cwd: string, scope: AgentScope): AgentDiscoveryResult {
	...
	// Bundled pstack agents have the lowest precedence: user and project definitions win.
	const bundledAgents = scope === "project" ? [] : loadAgentsFromDir(bundledAgentsDir, "package");
