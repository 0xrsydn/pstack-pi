...
- `Read` tool calls against any `SKILL.md` file (workspace `.pi/skills/`, user-level `~/.pi/agent/skills/`, or package-installed skills under pi packages)
- Spawn briefs that name a skill path
